...
abstract class ThemeControllerBase with Store {
  ...
  ColorScheme getCurrentTheme() {
    return ColorScheme(
      brightness: themeBrightness,
      primary: themeColor,
      onPrimary: themeBrightness == Brightness.dark
          ? HexColor('#ffffff')
          : HexColor('#000000'),
      secondary: themeColor,
      onSecondary: themeBrightness == Brightness.dark
          ? HexColor('#ffffff')
          : HexColor('#000000'),
      tertiary: themeColor,
      onTertiary: themeBrightness == Brightness.dark
          ? HexColor('#ffffff')
          : HexColor('#000000'),
      error: HexColor('#bd0000'),
      onError: themeBrightness == Brightness.dark
          ? HexColor('#ffffff')
          : HexColor('#000000'),
      background: themeBrightness == Brightness.dark
          ? HexColor('#111111')
          : HexColor('#eeeeee'),
      onBackground: themeBrightness == Brightness.dark
          ? HexColor('#ffffff')
          : HexColor('#000000'),
      surface: themeBrightness == Brightness.dark
          ? HexColor('#222222')
          : HexColor('#ffffff'),
      onSurface: themeBrightness == Brightness.dark
          ? HexColor('#ffffff')
          : HexColor('#000000'),
    );
  }
